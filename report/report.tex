...
For the downstream datasets, macro-F1 is reported together with accuracy because it is more informative than accuracy alone when class balance matters.
...
\toprule
Model & Acc. & Macro Prec. & Macro Recall & Macro-F1 & Weighted-F1 & Time \\
\midrule
...
\toprule
Model & Init & Acc. & Macro Prec. & Macro Recall & Macro-F1 & Weighted-F1 & Time \\
\midrule
