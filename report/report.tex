...
Here, \texttt{ToTensor()} and normalization are preprocessing transforms. The random crop and horizontal flip are augmentation transforms.
...
\begin{tabular}{lcccc}
\toprule
Model & Clean Acc. & Occluded Acc. & Texture Acc. & Params \\
\midrule
CNN & 85.70\% & 80.32\% & 32.98\% & 374{,}282 \\
ViT & 73.36\% & 68.81\% & 50.26\% & 1{,}803{,}850 \\
\bottomrule
\end{tabular}
\end{table}
